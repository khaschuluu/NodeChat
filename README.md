...
* (http://github.com/cloudhead/less.js) - CSS динамик хэл
* (http://github.com/visionmedia/jade) - HTML динамик хэл
* (http://github.com/learnboost/socket.io) - Сервер, клиент real-time холболтын орчин
